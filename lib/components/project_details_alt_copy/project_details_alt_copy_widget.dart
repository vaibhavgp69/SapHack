...
class ProjectDetailsAltCopyWidget extends StatefulWidget {
  const ProjectDetailsAltCopyWidget({super.key});
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'fzk4ux47' /* Upload the images or the video... */,
                                      ),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'PROJECT_DETAILS_ALT_COPY_Image_aklxtqnx_');
                                              final selectedMedia =
                              ...
                              onPressed: () async {
                                ...
                                await QuestionsRecord.collection
                                    ...
                                    .set(createQuestionsRecordData(
                                      question1: _model.textController1.text,
                                      question2: _model.textController2.text,
                                    ));
